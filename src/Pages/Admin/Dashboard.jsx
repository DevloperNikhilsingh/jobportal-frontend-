    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const [statsRes, applicationsRes, requestsRes, messagesRes] = await Promise.all([
          fetch('https://jobportal-backend-production-9a5e.up.railway.app/api/admin/dashboard-stats', { headers }),
          fetch('https://jobportal-backend-production-9a5e.up.railway.app/api/admin/applications', { headers }),
          fetch('https://jobportal-backend-production-9a5e.up.railway.app/api/admin/want-to-hire-requests', { headers }),
          fetch('https://jobportal-backend-production-9a5e.up.railway.app/api/admin/contact-enquiries', { headers }),
        ]);
