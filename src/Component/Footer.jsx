            ...
            <footer className="bg-[#0F172A] text-white py-6 px-4 overflow-x-hidden" >
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 py-6">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3 mt-6">
                            <a href="#Postjob" className="hover:text-violet-400 transition">Post Job</a>
                            ...
                            <a href="#faq" className="hover:text-violet-400 transition">FAQs</a>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3 mt-6">
                            <a href="#jobs" className="hover:text-violet-400 transition">Browse Jobs</a>
                    ...
                    >
                        ...
                        <div className="flex flex-wrap items-center gap-3 mt-6">
                            <a href="https://www.linkedin.com/company/i-p-tech-digital-solutions/posts/?feedView=all" target='_blank'>
                                <motion.img
                                    src="LinkedIn (2).svg"
                                    alt="LinkedIn"
